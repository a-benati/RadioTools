...
# Common variables
center = [-56.949395391,-56.795908456]
size = [1.065441*2,1.189075]
z = 0.0553  # redshift
...
def plot_image(image, vmax, ticks, output_file):
    ...
    # Colorbar
    cbaxes = fig.add_axes([0.127, 0.9, 0.772, 0.02])  # Adjusted for proper colorbar positioning
...
plot_image(
    ...
    output_file='/data/abell_3667/img_pdf/abell3667_L.pdf'
)
...
plot_image(
    ...
    output_file='/data/abell_3667/img_pdf/abell3667_UHF.pdf'
)
