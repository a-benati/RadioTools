...
def main():
    ...
    parser = argparse.ArgumentParser(description="Compute polarisation fraction and angle from Stokes I, Q, U, V fits files")
    ...
    parser.add_argument("--V", required=True, help="FITS file for Stokes V")  # Including V, though it's not used here
    parser.add_argument("--output_prefix", required=True, help="Output prefix for the generated FITS files")
